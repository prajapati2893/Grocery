...
$ordnm = !empty($_REQUEST['ord'])?$_REQUEST['ord']:"";
$ordnm = base64_decode(str_replace("=","",str_replace("'","",$ordnm)));
if($crtemp=="emty")
{
			...
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
                  ...
                  <?php
                    ...
                    if(!empty($usrid)){
                       $crtdata = mysqli_query($conn,"SELECT * FROM tbl_order where userid='".$usrid."' and order_number='".$ordnm."'");
                      $sl=1;
                      $totalpric ='';
