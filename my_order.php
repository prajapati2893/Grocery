			...
			<div class="container">
    			...
    			<div class="col-md-12 ftco-animate">
                  ...
                  <?php
                    ...
                    if(!empty($usrid)){
                       $crtdata = mysqli_query($conn,"SELECT * FROM tbl_order where userid='".$usrid."' group by order_number");
                      $sl=1;
                      $totalpric ='';
                   ...
                   <td class="product-remove"><a href="vieworder.php?ord=<?php echo base64_encode($product["order_number"]);?>"><?php echo $product["order_number"];?></a></td>

						        <td class="product-remove"><a href="vieworder.php?ord=<?php echo base64_encode($product["order_number"]);?>"><?php echo $product["delivery_status"];?></a></td>

                     <td class="product-remove"><a href="vieworder.php?ord=<?php echo base64_encode($product["order_number"]);?>"><?php echo date('d-m-Y',strtotime($product["datetime"]));?></a></td>
						        
                					        
						        <td class="total"><a href="vieworder.php?ord=<?php echo base64_encode($product["order_number"]);?>"><span id="sumtot<?php echo $sl;?>"><?php echo number_format(str_replace(",","",$product["total_amount"]),2);?></span></a></td>
						      </tr>
