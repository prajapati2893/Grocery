             ...
             <!-- <a name="deleted"></a><a style="float: right; cursor: pointer;" href="cart.php?crt=emty" onclick="return confirm('Are you sure ?')" >Empty Cart</a>-->
                  ...
                  <?php
                   ...
                   while ($product =  mysqli_fetch_array($crtdata)){ 
                      ...
                      $realpric = (float)getorgianlprice($prodid,$conn); 
                      $prodprce = (float)$product["pprice"];
                    ...
                    ?>
						        ...
						        <td class="image-prod">
								<img class="img" src="upload/<?php echo $product["pimage"]; ?>">
								<?php /*<div class="img" style="background-image:url(upload/<?php echo $product["pimage"]; ?>);"></div>*/?>
								</td>
							...
							<td class="price">Rs.<?php echo number_format($realpric,2); ?></span></td>
						      <td class="price">Rs.<span id="prodpr<?php echo $sl;?>"><?php echo $realpric-$product["pprice"]; 
								$prodpric += $realpric?></span></td>
    		...
    		<div class="row justify-content-end">
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				<div class="cart-total mb-3">
    					...
    					<p class="d-flex">
    						<span>Subtotal</span>
    						<span>Rs. <?php  echo $totalpric+$totaldiscount;
							if(@$totalpric!=0) { 
							$_SESSION['Final_total'] = number_format($totalpric,2); 
							//echo number_format($totalpric,2); 
							} else {  
							$_SESSION['Final_total']=0; //echo '0';
							} ?></span>
    					</p>
    					<p class="d-flex">
    						<span>Discount</span>
    						<span>Rs <?php if(@$totaldiscount!=0) { $_SESSION['totaldiscount']= $totaldiscount; echo ' -'.number_format($totaldiscount,2); }?></span>
    					</p>
                <p class="d-flex">
                <span>Delivery</span>
